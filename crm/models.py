...
class Order(models.Model):
    ...
    order_status = models.ForeignKey(
        StatusCrm, on_delete=models.PROTECT, null=True, blank=True, verbose_name='Status')
...
class CommentCrm(models.Model):
    comment_binding = models.ForeignKey(
        Order, on_delete=models.CASCADE, verbose_name='Request')
    comment_text = models.TextField(verbose_name='Comment text')
    comment_dt = models.DateTimeField(
